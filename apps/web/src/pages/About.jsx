    ...
    <div className="profile-card">
      ...
      <div className="space-y-3 text-sm leading-relaxed" style={{ color: 'hsl(120, 5%, 50%)' }}>
        ...
        <p>
          ...
          I enjoy the entire journey: from writing backend APIs to designing pixel-perfect frontends and deploying end-to-end solutions.
        </p>
        <p>
          ...
          Whether it's building real-time systems or optimizing developer workflows, I'm always looking for impactful problems to solve.
        </p>
      </div>
        ...
        {[
          ...
          <div key={i} className="feature-card !text-left">
            <div className="flex items-start gap-3">
              <div className="w-9 h-9 rounded flex items-center justify-center flex-shrink-0" style={{ background: 'hsl(180, 100%, 45%, 0.08)', border: '1px solid hsl(180, 100%, 45%, 0.15)' }}>
